...
function SimpleInput({ type, placeholder }: any) {
  return (
    <input
      type={type}
...
function SimpleInputWithDescription({ type, placeholder, desc }: any) {
  return (
...
function SimpleTextArea({ row, placeholder }: any) {
  return (
    <textarea
      rows={row ?? 3}
      defaultValue=""
...
function GroupedInputSelectStart({ type, placeholder, items }: any) {
  return (
...
function SimpleSelect({ items }: any) {
  return (
...
function SimpleCheckbox({ title, desc }: { title: string; desc: string }) {
  return (
